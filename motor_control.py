...
import json
import numpy as np
import basics.L2_inverse_kinematics as ik
import basics.L2_kinematics as kin
...
ANGLE_MARGIN = 5        # Radians object can be from image center to be considered "centered"
...
class MotorControl:
    ...
    def __init__(self):
        ...
        #Pallet Info#
        self.pallet_target_width = None
        self.pallet_target_angle = None
