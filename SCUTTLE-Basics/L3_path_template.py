...
motions = [
    [0.30, 0.0, 2.0],            # Motion 1
    [0.40, pi/2, 1.0],            # Motion 2
    [0.30, 0.0, 2.0],            # Motion 3
    [0.40, pi/2, 1.0],            # Motion 4
    [0.30, 0.0, 2.0],            # Motion 5
    [0.4, -pi/2, 1.0],            # Motion 6
    [0.30, 0.0, 2.0],            # Motion 7
    [0.4, -pi/2, 1.0],   
    [0.30, 0.0, 2.0],         # Motion 8
]
